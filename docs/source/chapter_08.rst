...
#. Написать кэширование к при работе с языком, чтобы не обращаться с запросом в БД при обработке каждого события. Реализовать хранение, например, в сторадже Redis.
